...
CREATE TABLE `attendance` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_attendance` (`session_id`,`user_id`,`course_id`,`date`),
...
INSERT INTO `attendance` VALUES (61,6,18,10,'2024-07-06','present'),(62,6,19,10,'2024-07-06','present'),(63,6,18,10,'2024-07-07','present');
